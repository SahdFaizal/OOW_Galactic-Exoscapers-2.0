...
# Define directories for Mars data
data_directories = [
    './data/mars/test/data/'
]
...
def predict_and_compare(model_filename, scaler_filename):
    ...
    predictions_df.to_csv(os.path.join(output_catalog_directory, 'Output_Catalog_Mars.csv'), index=False)

if __name__ == "__main__":
    model_filename = os.path.join(resources_directory, "mars_gradient_boosting_model.pkl")
